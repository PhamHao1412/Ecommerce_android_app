...
import StoreApp.StoreApp.repository.SpecificationRepository;
...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<String> findColor_ProductByName(String productName, String capacity) {
		return productRepository.findColorsByProductByName(productName,capacity);
	}

	@Override
	public List<String> findCapacity_ProductByName(String productName, String color) {
		return productRepository.findCapacityByProductByName(productName,color);
	}

	@Override
	public Product findProductByColorAndCapacity(String productName, String color, String capacity) {
		return productRepository.findProductByColorAndCapacity(productName,color,capacity);
	}

	@Override
	public Specifications findSpecByProductId(int product_id) {
		return specificationRepository.findByProductId(product_id);
	}

	@Override
	public Specifications saveSpec(Specifications specifications) {
		return specificationRepository.save(specifications);
	}

	@Override
	public Product getProductByCart_id(int cart_id) {
		return null;
	}
}
